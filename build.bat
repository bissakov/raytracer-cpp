...
set src_files=%src_dir%\main.cpp %src_dir%\point_vector.cpp %src_dir%\pixel.cpp %src_dir%\canvas.cpp %src_dir%\matrix.cpp %src_dir%\ray.cpp %src_dir%\file_io.cpp %src_dir%\str.cpp %src_dir%\arr.cpp %src_dir%\test_suite.cpp %src_dir%\utils.cpp
